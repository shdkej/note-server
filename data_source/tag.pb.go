...
var file_tag_proto_rawDesc = []byte{
	,
}
...
var file_tag_proto_goTypes = []interface{}{
	(*Note)(nil),    // 0: data_source.Note
	(*Message)(nil), // 1: data_source.Message
}
var file_tag_proto_depIdxs = []int32{
	1, // 0: data_source.TagManager.GetTag:input_type -> data_source.Message
	1, // 1: data_source.TagManager.GetTags:input_type -> data_source.Message
	0, // 2: data_source.TagManager.GetTag:output_type -> data_source.Note
	0, // 3: data_source.TagManager.GetTags:output_type -> data_source.Note
...
type TagManagerClient interface {
	GetTag(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Note, error)
...
func (c *tagManagerClient) GetTag(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := c.cc.Invoke(ctx, "/data_source.TagManager/GetTag", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tagManagerClient) GetTags(ctx context.Context, in *Message, opts ...grpc.CallOption) (TagManager_GetTagsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_TagManager_serviceDesc.Streams[0], "/data_source.TagManager/GetTags", opts...)
	if err != nil {
		return nil, err
	}
...
type TagManagerServer interface {
	GetTag(context.Context, *Message) (*Note, error)
	GetTags(*Message, TagManager_GetTagsServer) error
}

// UnimplementedTagManagerServer can be embedded to have forward compatible implementations.
type UnimplementedTagManagerServer struct {
}

func (*UnimplementedTagManagerServer) GetTag(context.Context, *Message) (*Note, error) {
...
func RegisterTagManagerServer(s *grpc.Server, srv TagManagerServer) {
	s.RegisterService(&_TagManager_serviceDesc, srv)
}
...
func _TagManager_GetTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_source.TagManager/GetTag",
	}
...
var _TagManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "data_source.TagManager",
